...
#COLOR 256
NFORMAT="\033[0m"
ORANGEB="\033[1;38;5;208m"
TGREENB="\033[1;38;5;118m"
REDB="\033[1;38;5;1m"
CYANB="\033[1;38;5;87m"
BLACKB="\033[1;38;5;0m"
WHITEB="\033[1;38;5;15m"
GRAYB="\033[1;90m"

clear
neofetch
echo -e "${TGREENB}################################################${NFORMAT}"
echo -e "${TGREENB}# ${WHITEB}AUTOSCRIPT TUNNELING VNZVPN ${TGREENB}2.0 ${ORANGEB}BETA ${TGREENB}        # ${NFORMAT}"
echo -e "${TGREENB}# ${WHITEB}DEVELOPER : ${ORANGEB}t.me/VnzVM ${TGREENB}                      # ${NFORMAT}"
echo -e "${TGREENB}# ${WHITEB}CHANNEL   : ${ORANGEB}t.me/VnzVPN ${TGREENB}                     # ${NFORMAT}"
echo -e "${TGREENB}################################################${NFORMAT}"
echo -e "${WHITEB}SILAKAN KETIKKAN ${TGREENB}menu ${WHITEB}UNTUK MELIHAT FITUR SCRIPT${NFORMAT}"
